...
2. 聊天页面消息细节控制框
(重新生成，删除记录，修改记录，连续发送等)
3. ai对话历史拆分功能探讨  
是否要拆分ai对话历史，对每个节点维护单独的对话记录，以缓解长上下文下的注意力衰退问题（必须拆分）
4. 提示词逻辑拆分与可视化配置  
将提示词从代码内的硬编码迁出，支持界面化编辑、导入、导出，便于优化提示词。支持多组subagent提示词管理
